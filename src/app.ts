...
export class MyAmazingCliApp implements OnInit {
...
//#region  my-amazing-cli api service
...
//#region  my-amazing-cli app configs
//#region @browser
export const MyAmazingCliAppConfig: ApplicationConfig = {
  providers: [
    provideZonelessChangeDetection(),
    {
      provide: TAON_CONTEXT,
      useFactory: () => MyAmazingCliContext,
    },
    providePrimeNG({
      theme: {
        preset: Aura,
    ...
    }),
    {
      ...
      multi: true,
      useFactory: () => MyAmazingCliStartFunction,
    },
    provideBrowserGlobalErrorListeners(),
    // remove withHashLocation() to use SSR
    provideRouter(
      MyAmazingCliClientRoutes,
      withHashLocation(),
      withComponentInputBinding(),
    ),
...
export const MyAmazingCliServerConfig: ApplicationConfig = {
  providers: [provideServerRendering(withRoutes(MyAmazingCliServerRoutes))],
};

export const MyAmazingCliConfig = mergeApplicationConfig(
  MyAmazingCliAppConfig,
  MyAmazingCliServerConfig,
);
//#endregion
//#endregion
...
//#region  my-amazing-cli migration
...
//#region  my-amazing-cli start function
export const MyAmazingCliStartFunction = async (
  startParams?: Taon.StartParams,
): Promise<void> => {
  await MyAmazingCliContext.initialize();
...
export default MyAmazingCliStartFunction;
//#endregion
